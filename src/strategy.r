...
run_strategy <- function(quotes, rule) {
	...
	models$stopped.rule = bt.run.share(quotes, clean.signal=T, trade.summary = TRUE)
	#models$longshort = bt.run.share(quotes, clean.signal=T, trade.summary = TRUE)
	#models$long = bt.run.share(quotes, clean.signal=T, trade.summary = TRUE)
	#models$short = bt.run.share(quotes, clean.signal=T, trade.summary = TRUE)
